      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-heading text-lg font-bold">The Ivy Project</h3>
            ...
            <div className="flex items-center space-x-2 text-sm">
              ...
              <span className="opacity-80">Certified therapy dog services since 2022</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+12098199985" className="text-sm opacity-80 hover:opacity-100 hover:text-primary transition-colors">
                  (209) 819-9985
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-4 h-4 text-primary" />
                <span className="text-sm opacity-80">Midland, TX</span>
              </div>
            </div>
            ...
            <div className="mb-3">
              ...
              <div className="flex space-x-3">
                ...
                <a 
                  href="https://www.tiktok.com/@ivydood" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors"
                  aria-label="TikTok"
        ...
        <div className="border-t border-background/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm opacity-60 mb-4 md:mb-0">
            © 2024 The Ivy Project. All rights reserved. | A 501(c)(3) non-profit organization.
          </div>
